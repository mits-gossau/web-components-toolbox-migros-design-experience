...
const Filter = class {
    ...
    render() {
        return !this.isFilterHidden ? (h(Host, null, h("mdx-filter-select", { label: this.buttonSelectLabel, "clear-button-aria-label": this.clearButtonSelectAriaLabel, selectedOptions: Object.values(this.selectedItems)
                .flat()
