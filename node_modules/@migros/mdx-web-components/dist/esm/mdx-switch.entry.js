...
const Switch = class {
  ...
  render() {
    return (h("button", { class: `switch${this.selected ? ' switch--selected' : ''}`, onClick: () => {
        this.selected = !this.selected;
        this.toggle.emit({ selected: this.selected });
      }, "aria-pressed": this.selected, disabled: this.disabled, "aria-label": this.ariaLabel }, h("span", { class: "switch__nob" })));
  }
};
