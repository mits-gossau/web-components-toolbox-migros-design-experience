...
const Textarea = class {
    ...
    render() {
        return (h("label", { key: '84f014f230a6efecb96856d8be13a001bafd5b93', class: `textarea ${this.focused && 'textarea--focused'}` }, h("div", { key: '7fb330f19bf0e6fb8c3b5c1c53f10aeb14550c40', class: "textarea__label-text" }, this.label, " ", this.required && h("span", { class: "asterisk" }, "*")), h("textarea", { key: '5bdd9b86ddbb693ec3c8f20dc33f932397899c66', class: "textarea__field", onFocus: () => this.keyboardEvent && (this.focused = true), onBlur: () => (this.focused = false), onInput: (e) => {
                this.handleValue(e);
            ...
            }, required: this.required, placeholder: this.placeholder, disabled: this.disabled, value: this.value }), h("div", { key: '2200198c6c47cff1e59db7a82c2de92ab97fe456', class: "textarea__information-wrapper" }, h("div", { key: '0ffc925527de0259392bec1d34eaa3176e06b872' }, this.hint && (typeof this.error === 'undefined' || this.error === '') && (h("span", { class: "textarea__hint" }, this.hint)), this.error && h("mdx-error-hint", { class: "textarea__error-message", text: this.error })), this.counter && this.counter > 0 && (h("span", { class: "textarea__counter" }, this.value.length, " / ", this.counter)))));
    }
};
