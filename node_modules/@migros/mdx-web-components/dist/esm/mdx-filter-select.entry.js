...
const FilterSelect = class {
    ...
    render() {
        return this.selectedOptions.length > 0 ? (h("mdx-filter-select-button", { badge: this.badge, label: this.displayedLabel, clearButtonAriaLabel: this.clearButtonAriaLabel })) : (h("mdx-select-button", { open: this.open, text: this.label }));
    }
