...
const Expand = class {
    ...
    componentWillRender() {
        this.host.style.setProperty('--expand-line-clamp', this.lineClamp > 1 ? this.lineClamp.toString() : '');
    }
    render() {
        return (h("div", { key: '885f06cf56d3689ddfd6afaf9f533a1fcf6fa179', class: `expand${this.expanded === undefined ? '' : this.expanded === true ? ' expand--is-expanded' : ' expand--is-collapsed'}` }, h("div", { key: '04f0116870376b15f306f60358f94822b7e8ecea', class: "expand__content" }, h("slot", { key: '996f3199eb6f8fb3f3c88a50307b636e814b51bd' })), h("button", { key: 'a5da14c402f8ce70d75ea71989b6dfff311fff83', class: "expand__button", onClick: () => {
                var _a, _b;
                if (this.expanded) {
                    const height = (_b = (_a = this.host.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelector('.expand__content')) === null || _b === void 0 ? void 0 : _b.clientHeight;
                    if (typeof height === 'number') {
                        this.host.style.setProperty('--expand-height', `${height}px`);
                    }
                    else {
                        this.host.style.setProperty('--expand-height', '100vh');
                    }
                }
                this.expanded = !this.expanded;
            } }, this.expanded ? this.labelOpen : this.labelClosed, h("mdx-icon-chevron-down", { key: '488aeba6198abf00dfe5463f7a6343700cb18162', class: "expand__icon", size: ICON_SIZES.XS }))));
    }
    get host() { return getElement(this); }
};
Expand.style = MdxExpandStyle0;
