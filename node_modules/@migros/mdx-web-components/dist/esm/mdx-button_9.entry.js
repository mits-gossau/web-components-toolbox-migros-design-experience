import { r as registerInstance, h, g as getElement, c as createEvent, H as Host } from './index-7e8279cb.js';
    ...
    componentDidLoad() {
        ...
        if (this.type === BUTTON_TYPE.SUBMIT) {
            ...
            button === null || button === void 0 ? void 0 : button.addEventListener('click', () => {
                var _a, _b;
                if ((_a = this.internals.form) === null || _a === void 0 ? void 0 : _a.checkValidity()) {
                    (_b = this.internals.form) === null || _b === void 0 ? void 0 : _b.submit();
                }
                else {
                    return;
                }
...
const Input = class {
    ...
    handleInputChange(e) {
        ...
        if (this.counter !== undefined && (v.length || 0) > this.counter) {
    ...
    inputValidation(e) {
        ...
        this.validationMessage = !this.isValid ? this.errorMessage || inputElement.validationMessage : '';
        this.internals.setValidity({ customError: !this.isValid }, this.validationMessage);
    }
    select(item) {
    ...
    componentDidRender() {
        ...
        if (typeof this.errorMessage === 'string' && this.errorMessage !== '') {
            ...
            this.host.removeAttribute('error-message');
        }
    }
    connectedCallback() {
    ...
    render() {
        return (h(Host, { key: '2c4969a98fbdc4ab4902cc335307f5ca16304440', onItemClick: ({ detail: { item } }) => {
                this.select(item);
            } }, h("label", { key: '76aa22a2c2e7c82cccc67627223f7b01b9327231', class: `input ${this.focused && 'focused'}`, htmlFor: this.name }, h("div", { key: 'b4d7a08ce3dcacb8ce10028dc3079879e5d32730', class: "input__label" }, this.label, this.required && h("span", { class: "asterisk" }, "*")), h("div", { key: 'bca94bd38bbbb8fda4b56cc5d591ab33a734fd28', class: "input__wrapper" }, h("input", { key: 'e6592876061ab0b91b3acaed962a5f56b0e69064', class: `input__field ${this.type === INPUT_TYPES.PASSWORD
                ? this.isPasswordVisible
                    ? 'input__field-value--visible'
                    : 'input__field-value--hidden'
                : ''}`, type: this.type === INPUT_TYPES.PASSWORD && this.isPasswordVisible ? INPUT_TYPES.TEXT : this.type, onFocus: () => this.keyboardEvent && (this.focused = true), onBlur: () => (this.focused = false), onInput: (e) => this.handleInputChange(e), required: this.required, placeholder: this.placeholder, disabled: this.disabled, value: this.value, pattern: this.inputPattern, name: this.name }), this.showIconContainer && (h("div", { class: "input__icon-container" }, this.loading && h("mdx-spinner", { class: "input__loading-spinner", size: SPINNER_SIZES.MEDIUM }), this.type === INPUT_TYPES.PASSWORD && (h("button", { class: "input__password-icon-button", onClick: () => this.handlePasswordVisibilityChange(), "aria-label": this.passwordInputIconAriaLabel }, !this.isPasswordVisible ? (h("mdx-icon-eye", { size: ICON_SIZES.SM })) : (h("mdx-icon-eye-off", { size: ICON_SIZES.SM })))), h("slot", { name: "icon" })))), h("div", { key: '8e2408e7059e049c0ba8bfc69c7ad87a81aed1da', class: "input__information-wrapper" }, h("div", { key: '054162d6f0bc1d1a737a3db9ff530bdf22efaf29' }, typeof this.errorMessage === 'string' && this.errorMessage !== '' ? (h("mdx-error-hint", { class: "input__error-message", text: this.errorMessage })) : this.isValid === false ? (h("mdx-error-hint", { class: "input__error-message", text: this.validationMessage })) : (h("span", { class: "input__hint" }, this.hint))), this.counter && this.counter > 0 && (h("span", { class: "input__counter" }, this.value.length, " / ", this.counter)), this.value && this.suggestionList && this.suggestionList.length > 0 && this.type !== INPUT_TYPES.PASSWORD && (h("div", { class: "input__flyout" }, this.matchedInput.length > 0 && (h("mdx-flyout", null, this.matchedInput.map((element) => (h("mdx-flyout-item", { item: element.label, label: element.label })))))))))));
    }
    static get formAssociated() { return true; }
    get host() { return getElement(this); }
};
...
const Spinner = class {
    ...
    render() {
        return (h("svg", { key: 'a598292f23e5a7aa0cb4ceb2d3b2ae713021ed0e', class: "spinner", viewBox: "25 25 50 50", "stroke-width": "5" }, h("circle", { key: '4e8acac41a7399052ed6ab6ccf4407f01f3f7007', class: "spinner__circle", cx: "50", cy: "50", r: "20" })));
    }
};
