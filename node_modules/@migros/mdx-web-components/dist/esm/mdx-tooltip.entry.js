...
const Tooltip = class {
    ...
    render() {
        return (h("div", { key: '7fefa9534482869a386c720c12b0219d5b31c280', class: `tooltip ${this.position} ${this.isOpen ? 'open' : ''}`, onMouseEnter: () => this.handleMouseEnter(), onMouseLeave: () => this.handleMouseLeave(), onFocusout: () => (this.isOpen = false), onFocusin: () => (this.isOpen = true), onClick: () => this.handleButtonClick(), "aria-haspopup": "true" }, h("slot", { key: 'be0091fed857b9c4a11dc026de5995038cc6d6e2' }), h("div", { key: '4a47b2b1687f2ebdc40f3bc89e85d7f0558ab453', class: `tooltip__flyout${this.hasIconSlot() ? ' tooltip__flyout--has-icon' : ''}${this.isOpen ? ' tooltip__flyout--is-open' : ''}` }, h("slot", { key: 'b5725058b78e3c355a6e7be18915e480c1beb0da', name: "icon" }), h("slot", { key: 'e54104525d0c65c1c7443e3fc567bf607d0ba089', name: "title" }), h("slot", { key: 'f5d07e76b05f451ce41ea34b6b832516e466a3cc', name: "content" }))));
    }
