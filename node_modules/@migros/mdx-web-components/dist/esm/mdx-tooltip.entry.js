import { r as registerInstance, h, g as getElement } from './index-1942bff0.js';
...
const MdxTooltipStyle0 = tooltipCss;
...
const Tooltip = class {
    ...
    render() {
        return (h("div", { key: '44029058a691f2c1c02504da5b1ab01913a6f696', class: `tooltip ${this.position} ${this.isOpen ? 'open' : ''}`, onMouseEnter: () => this.handleMouseEnter(), onMouseLeave: () => this.handleMouseLeave(), onFocusout: () => (this.isOpen = false), onFocusin: () => (this.isOpen = true), onClick: () => this.handleButtonClick(), "aria-haspopup": "true" }, h("slot", { key: '4a58b71429afcd90f443507000a7e8042a627c20' }), h("div", { key: '68a47ddc02e1bbc332684c9bbd881eee80d04814', class: `tooltip__flyout${this.hasIconSlot() ? ' tooltip__flyout--has-icon' : ''}${this.isOpen ? ' tooltip__flyout--is-open' : ''}` }, h("slot", { key: '7adda167d0549eb97d991b4c6c3f487b6510e245', name: "icon" }), h("slot", { key: 'e2e73c8be4fa630e149b642ed82f05a1c45ef71c', name: "title" }), h("slot", { key: '681f8d83634ae2db0d4602dad3e5f0e659e85620', name: "content" }))));
    }
    get host() { return getElement(this); }
};
Tooltip.style = MdxTooltipStyle0;
